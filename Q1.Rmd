...
1b: How do the different traits (domestication, thermy, vertebrates etc.) affect heritability?
Hypothesis 1a: Heritability will increase/decrease as you move up the taxonomic rank.
1b: Heritability will change based on the different levels of traits (vertebrate, thermy, domestication, and lab/field conditions). 
